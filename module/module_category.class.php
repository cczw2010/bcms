...
final class Module_Category{
 ...
 //数据处理部分==============================
	...
	/**
	 * 编辑分类
	 * @param array $arrs 编辑的分类数据键值对,不能包含id;不需要包含path,depth,程序会自己计算
	...
	/**
	 * 获取parent下的所有子类，并按树形结构排列分类(排序，增加制表符)
	 * @param array $datas getChilds中返回的分类数据数据
	 * @param int $selectid 初始化选中的分类id
