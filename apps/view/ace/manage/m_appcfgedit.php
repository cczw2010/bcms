<div class="alert alert-info">
	<i class="icon-warning-sign"></i>tips:sdk从数据库中获取配置信息
</div>
<form action="/manage/setting/thirdloginedit/">
<table class="table table-striped table-bordered table-hover dataTable" border="0" cellpadding="10" cellspacing="1" width="80%" >
	<thead>
		<tr>
