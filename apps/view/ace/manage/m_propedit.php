...
<table class="table table-striped table-bordered table-hover dataTable" border="0"  width="80%"  cellpadding="10" cellspacing="1" >
	...
	<tbody>
		...
		<tr>
			<td>状态:</td>
			<td>
				启用<input class="" type="radio" <?=(!isset($prop) || $prop['status']==1)?'checked="checked"':'';?> name="status" value="1" >
		...
		<tr>
			<td colspan="2" class="ccenter">
				...
				<input type="button" name="submitbtn" class="submitbtn button" value="提 交">
			</td>
		</tr>
	</tbody>
</table>
